...
var U;
async function C() {
  if (!g || (J = (await import("./node_url-6BIV7MYO.js")).default, q = await import("./node_fs-KP4XMRG4.js"), U = await import("./promises-ELCTGSBO.js"), Y = (await import("./node_vm-WNE7DBMI.js")).default, D = await import("./node_path-P3ZF5MV7.js"), M = D.sep, typeof A < "u")) return;
  let e = q, t = await import("./node_crypto-OPYK4ANM.js"), r = await import("./ws-MVPV7GAM.js"), s = await import("./node_child_process-OFKKVJQV.js"), a = { fs: e, crypto: t, ws: r, child_process: s };
...
async function X() {
  ...
  if (g && !t.startsWith("file://") && (t = `file://${t}`), j) {
    let s = await import("./node_path-P3ZF5MV7.js");
    return (await import("./node_url-6BIV7MYO.js")).fileURLToPath(s.dirname(t));
  }
